...
def init_game():
    global hero
    hero.rect.x = (WORLD_WIDTH - hero.rect.width) // 2  # definimos la posición inicial del sprite
...
pygame.display.set_caption('Circus')
...
img_menu_title = font_title.render("CIRCUS", False, (0, 255, 0))
